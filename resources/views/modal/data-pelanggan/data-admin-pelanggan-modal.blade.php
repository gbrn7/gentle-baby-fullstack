  ...
  <div class="modal-dialog ">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action={{route('data.admin.pelanggan.store')}} enctype="multipart/form-data" id="addForm" method="POST">
          @csrf
          <input type="hidden" name="idCompany" value="" id="idCompany">
...
<div class="modal fade" id="deletemodal" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog ">
    <div class="modal-content">
      ...
      <form action={{route('data.admin.pelanggan.delete')}} method="post">
        @method('delete')
        @csrf
...
<script type="text/javascript">
  ...
  function getDataAdminForm(id){
    $.get("{{ route('data.admin.pelanggan.getForm') }}",{id:id}, function(data){
