...
<div class="content-box mb-md-0 mb-5 mt-3 rounded rounded-2 bg-white">
  <div class="content rounded rounded-2 border border-1 p-2">
    ...
    <form action={{route('data.product.store')}} enctype="multipart/form-data" id="addForm" method="POST">
      @csrf
        ...
        <div class="row justify-content-start">
          ...
          <div class="col-12 col-md-5 mt-3 mt-md-0">
            ...
            <div class="form-group mb-3">
              ...
              <input required value="{{old('price')}}" class="form-control" type="number" name="price" id="price"
                placeholder="Masukkan harga produk" />
            </div>
            <div class="form-group mb-3">
              <label for="size_volume" class="mb-1">Ukuran Volume</label>
              <input required value="{{old('size_volume')}}" class="form-control" type="number" name="size_volume"
            ...
            <div class=" form-group mb-3">
              ...
              <select required id="is_cashback" name="is_cashback" class="form-select status"
                ...
                <option {{old('is_cashback' )==='0' ? 'selected' : '' }} value="0" class="text-secondary">Tidak
                </option>
              </select>
            </div>
            <div class="form-group mb-3">
            ...
            <div class=" form-group mb-3">
              ...
              <select required id="status" name="status" class="form-select status" aria-label="Default select example">
                <option {{old('status' )==='active' ? 'selected' : '' }} value="active" class="text-secondary">
                  Aktif
                </option>
                <option {{old('status' )==='inactive' ? 'selected' : '' }} value="inactive" class="text-secondary">Tidak
                  Aktif
                </option>
              </select>
            </div>
